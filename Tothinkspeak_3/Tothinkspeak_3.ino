...
void loop() {
  ...
  if(ret)     // GET DATA OK
  {
      Serial.print("14 Day Gunny humidity: ");
      Serial.print(humi1*100);
      Serial.print("%\t 14 Day Gunny temerature: ");
  ...
  if(ret2)     // GET DATA OK
  {
      Serial.print("14 Day Sprinkler humidity2: ");
      Serial.print(humi2*100);
      Serial.print("%\t 14 Day Sprinkler temerature2: ");
